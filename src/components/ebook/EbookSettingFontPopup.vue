<template>
  <transition name="popup-slide-up">
    <div class="ebook-popup-list" v-show="getFontFamilyVisible">
...
export default {
  ...
  methods: {
    ...
    setFontFamily (font) {
      saveFontFamily(this.getFileName, font)
      this.setDefaultFontFamily(font)
      if (font === 'Default') {
        this.getCurrentBook.rendition.themes.font('Time New Roman')
      } else {
        this.getCurrentBook.rendition.themes.font(font)
      }
    },
    isSelected (item) {
      return this.getDefaultFontFamily === item.font
    }
  }
}
</script>
